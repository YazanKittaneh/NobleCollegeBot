...
class Coefficient(models.Model):
    COMPETATIVENESS = models.CharField(null=True, default='Test', max_length=50)
    MATCHCODE = models.CharField(null=True, default='0', max_length=50)
    GPACOEF	= models.DecimalField(null=True, default='000000000',max_digits=8, decimal_places=5)
    ACTCOEF = models.DecimalField(null=True, default='000000000',max_digits=8, decimal_places=5)
    INTERCEPT = models.DecimalField(null=True, default='000000000',max_digits=8, decimal_places=5)

class Custom_Coefficient(models.Model):
    SCHOOLCODE = models.CharField(null=True, default='Test', max_length=50)
    GPACOEF	= models.DecimalField(null=True, default='000000000',max_digits=8, decimal_places=5)
    ACTCOEF = models.DecimalField(null=True, default='000000000',max_digits=8, decimal_places=5)
    INTERCEPT = models.DecimalField(null=True, default='000000000',max_digits=8, decimal_places=5)
